...
<head>
    ...
    <title>Control de Gastos en PHP y MySQL</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-success bg-light col-12">
        <a class="navbar-brand ml-5" href="#">Control de Gastos en PHP y MySQL</a>
            ...
            <ul class="navbar-nav ml-auto mr-5">
                <li class="nav-item dropdown mr-5">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="https://www.configuroweb.com/">Más desarrollos</a>
                    </div>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-secondary col-md-3 float-right" data-toggle="modal" data-target="#expenseCategoryModal">&#43; Categoría de Gasto</button>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <button type="submit" title="Editar" onclick="update_category('<?php echo $categoryID ?>')"><i class="fa-solid fa-pencil"></i></button>
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-sm btn-outline-secondary col-md-2 float-right" data-toggle="modal" data-target="#expenseModal">&#43; Nombre del Gasto</button>
